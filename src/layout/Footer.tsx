...
import WhitepaperPDF from '../assets/Thai.pdf';
...
const Footer = () => {
  ...
  const handleWhitepaperClick = () => {
    // First navigate to the whitepaper page
    navigate(Pages.Whitepaper);
    
    // Then trigger download after a short delay to ensure navigation completes
    setTimeout(() => {
      // Create a link element
      const link = document.createElement('a');
      // Set the href to the imported PDF
      link.href = WhitepaperPDF;
      // Set download attribute to force download
      link.download = 'ThaiCoin-Whitepaper.pdf';
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} sm={6} md={3}>
            ...
            <Box component="nav" sx={{ display: 'flex', flexDirection: 'column' }}>
              ...
              <FooterLink onClick={handleWhitepaperClick}>Whitepaper</FooterLink>
              <FooterLink
                onClick={() => {
