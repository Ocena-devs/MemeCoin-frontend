...
const RoadmapItem: React.FC<RoadmapItemProps> = ({
  ...
  const cardVariants = {
    initial: { 
      opacity: 0, 
      x: isMobile ? 0 : (isFromLeft ? -100 : 100),
      y: isMobile ? 30 : 0,  // Reduced y distance on mobile
...
// Faster item animation for smoother scrolling
animate: (i: number) => ({
  opacity: 1, 
  x: 0,
  transition: { 
    duration: 0.6,  // Reduced duration
    delay: 0.2 + (i * 0.08)  // Reduced delay and stagger time
  }
})
  };
